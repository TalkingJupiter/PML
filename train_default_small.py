...
def parse_args():
    parser = argparse.ArgumentParser(description= "GNS-Vx on Cifar-10")
    parser.add_argument("--width", type=float, default=1.0)
    parser.add_argument("--outdir", type=str, default="out")
    parser.add_argument("--run_name", type=str, default="GN-S Vx")
...
def main():
    ...
    log_param_table(model, name=f"ghostnetv3_small (width={args.width})")
