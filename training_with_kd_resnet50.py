...
def parse_args():
    parser = argparse.ArgumentParser(description="KD Resnet50(Teacher) -> GhostNetV3 (student)")
    parser.add_argument("--student_width", type=float, default=1.0)
    parser.add_argument("--outdir", type=str, default="experiments")
    parser.add_argument("--run_name", type=str, default="KD_GN-D_1.0x_from_RES50")
    parser.add_argument("--teacher_run", type=str, default="R50_def")
...
def main():
    ...
    logging.info(f"Using GhostNetV3_small student with width {args.student_width}")
