#!/bin/bash
#SBATCH --job-name=kd_gns1.0x-resnet50
#SBATCH --partition=h100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=12:00:00
#SBATCH --output=slurm_logs/Table2/kd_gns1.0x-resnet50/%x-%j.out
#SBATCH --error=slurm_logs/Table2/kd_gns1.0x-resnet50/%x-%j.err
...
python training_with_kd_resnet50_small.py \
  --outdir experiments \
  --run_name KD_GN-S_1.0x_from_R50 \
  --student_width 1.0 \
