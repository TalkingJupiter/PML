#!/bin/bash
#SBATCH --job-name=kd_gns1.0x-vgg13
#SBATCH --partition=h100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=12:00:00
#SBATCH --output=slurm_logs/Table2/kd_gns1.0x-vgg13/%x-%j.out
#SBATCH --error=slurm_logs/Table2/kd_gns1.0x-vgg13/%x-%j.err
...
python training_with_kd_vgg13_bn_small.py \
  --outdir experiments \
  --run_name KD_GN-S_1.8x_from_VGG13BN \
  --student_width 1.0 \
