...
def parse_args():
    parser = argparse.ArgumentParser(description="KD: ResNet50 (teacher) -> GhostNetV3_small (student) on CIFAR-10")
    ...
    parser.add_argument("--run_name", type=str, default="KD_GN-S_1.0x_from_R50")

    # Teacher model location under experiments
    parser.add_argument("--teacher_run", type=str, default="R50_default")
...
def main():
    ...
    # ===== Teacher model: ResNet-50 (load from experiments/<teacher_run>/best_model.pth) =====
